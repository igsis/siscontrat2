                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" id="valor[]" name="valor[]"
                                       class="form-control" required onKeyPress="return(moeda(this,'.',',',event))"
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="date" name="data_inicio[]" class="form-control" id="datepicker10"
                                       placeholder="DD/MM/AAAA" required value="<?= $parcela['data_inicio'] ?? NULL ?>">
                            </div>

                            <div class="form-group col-md-2">
                                <label for="data_fim">Data final: </label>
                                <input type="date" name="data_fim[]" class="form-control" id="datepicker11"
                                       placeholder="DD/MM/AAAA" required value="<?= $parcela['data_fim'] ?? NULL ?>">
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="time" name="carga[]" class="form-control" id="carga[]"
                                       value="<?= $parcela['carga_horaria'] ?? NULL ?>" required placeholder="hh:mm">
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" name="mes_ref[]" class="form-control" id="mes_ref[]"
                                       ...
                                       title="Utilize somente letras" required>
                            </div>
                        </div>
                        <hr>
                        <?php
