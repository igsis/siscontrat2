...
function modalUploadFoto($idModal, $pagina, $nomeArquivo, $sigla, $idPessoa, $tipoPessoa)
{
    echo "
    <div class=\"modal fade\" id=\"$idModal\">
        <div class=\"modal-dialog\">
            <div class=\"modal-content\">
                ...
                <div class=\"modal-body\">
                    <p align='center'><strong>Arquivo somente em .JPG, .PNG, .jpg ou .png e até 05 MB.</strong></p>
                    <form method=\"POST\" action=\"$pagina\" enctype=\"multipart/form-data\">
                        <br/><div align='center'><input type='file' name='arquivo[$sigla]'></div> 
                        <br/>
                        <input type=\"hidden\" name=\"idPessoa\" value=\"$idPessoa\"  />
