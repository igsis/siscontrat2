...
if(isset($_POST['cadastra'])){
    $sql_atracoes = "INSERT INTO atracoes(evento_id, nome_atracao, categoria_atracao_id, ficha_tecnica, classificacao_indicativa_id, release_comunicacao, links, quantidade_apresentacao, publicado) VALUES ('$idEvento','$nome_atracao', '$categoria_atracao_id', '$ficha_tecnica', '$classificacao_indicativa_id', '$release_comunicacao', '$links', '$quantidade_apresentacao', '1')";
...
if(isset($_POST['edita'])){
    ...
    $sql_atracoes = "UPDATE atracoes SET nome_atracao = '$nome_atracao', categoria_atracao_id = '$categoria_atracao_id', ficha_tecnica = '$ficha_tecnica', classificacao_indicativa_id = '$classificacao_indicativa_id', release_comunicacao = '$release_comunicacao', links = '$links', quantidade_apresentacao = '$quantidade_apresentacao' WHERE id = '$idAtracao'";
    if(mysqli_query($con,$sql_atracoes)){
