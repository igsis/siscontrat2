...
if (isset($_POST['alterar'])) {
    ...
    $sql = "INSERT INTO usuario_pagamentos VALUES ('$idUsuario', '$idNivel')";
    $deleteRelacaoUser = "DELETE FROM usuario_pagamentos WHERE usuario_id = '$idUsuario'";
...
$usuarios = "SELECT u.id, u.nome_completo, na.nivel FROM usuario_pagamentos up INNER JOIN usuarios u ON u.id = up.usuario_id INNER JOIN nivel_acessos na on up.nivel_acesso = na.id WHERE u.publicado = 1";
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="tblResultado" class="table table-bordered table-striped">
                            ...
                            ?>
                            <tr>
                                <form action="?perfil=pagamento&p=admin&sp=lista_operadores" method="POST" role="form">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="?perfil=pagamento&p=admin&sp=lista_operadores" method="POST">
