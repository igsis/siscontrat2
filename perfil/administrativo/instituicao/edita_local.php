...
if (isset($_POST['cadastra']) || (isset($_POST['edita']))) {
    ...
    if (isset($_POST['cadastra'])) {
        $sql = "INSERT INTO locais (instituicao_id, local, logradouro, numero, complemento, bairro, cidade, uf, cep, zona_id, subprefeitura_id)
                VALUES ('$idInstituicao', '$local', '$rua', '$numero', '$complemento', '$bairro', '$cidade', '$estado', '$cep', '$zona', '$subprefeitura')";
    ...
    if (isset($_POST['edita'])) {
        ...
        $sql = "UPDATE locais SET local = '$local', logradouro = '$rua', numero = '$numero', complemento = '$complemento', bairro = '$bairro', cidade = '$cidade', uf = '$estado', cep = '$cep', subprefeitura_id = '$subprefeitura' WHERE id = '$idLocal'";
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Digite o Bairro" maxlength="80" readonly value="<?= $local['bairro'] ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="cidade">Cidade: *</label>
                                    <input type="text" class="form-control" name="cidade" id="cidade" placeholder="Digite a cidade" maxlength="50" readonly value="<?= $local['cidade'] ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="estado">Estado: *</label>
                                    <input type="text" class="form-control" name="estado" id="estado" maxlength="2" placeholder="Ex.: SP" readonly value="<?= $local['uf'] ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="estado">Subprefeitura: *</label>
                                    <select name="subprefeitura" class="form-control" required>
                                        <option value="">Selecione uma opção</option>
                                        <?= geraOpcao('subprefeituras', $local['subprefeitura_id']) ?>
                                    </select>
                                </div>
                            </div>
                        </div>
