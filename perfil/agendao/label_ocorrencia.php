                        ...
                        if ($ocorrencias->num_rows > 0) {
                            ...
                            foreach ($ocorrencias as $ocorrencia) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Data de
                                            Encerramento:</label> <?= $ocorrencia['data_fim'] == "0000-00-00" ? "Não é Temporada" : exibirDataBr($ocorrencia['data_fim']) ?>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Hora de
                                            Início:</label> <?= date("H:i", strtotime($ocorrencia['horario_inicio'])) ?>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Hora de
                                            Encerramento:</label> <?= date("H:i", strtotime($ocorrencia['horario_fim'])) ?>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Valor do
                                            Ingresso:</label> <?= $ocorrencia['valor_ingresso'] == "0.00" ? "GRÁTIS" : "R$" . dinheiroParaBr($ocorrencia['valor_ingresso']) ?>
                                    </div>
                                </div>
                                <div class="row">
