            ...
            if ($result = mysqli_query($con, $queryCPF)) {
                ...
                if ($resultCPF > 0) {
                    ...
                    $resultado = "<td colspan='4'>
                      ...
                      <td>
                        <form method='post' action='?perfil=contrato&p=pf&sp=cadastra'>
                            <input type='hidden' name='idAtracao' value='$idAtracao'>
                            <input type='hidden' name='idPedido' value='$idPedido'>
            ...
            if ($tipoDocumento == 2) {
                ...
                if ($result = mysqli_query($con, $queryPassaporte)) {
                    ...
                    if ($resultPassaporte > 0) {
                      ...
                      <td>
                        <form method='post' action='?perfil=contrato&p=pf&sp=cadastro'>
                            <input type='hidden' name='documentacao' value='$procurar'>
                            <input type='hidden' name='tipoDocumento' value='$tipoDocumento'>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="?perfil=contrato&p=pf&sp=pesquisa" method="post" id="formulario">
                    ...
                    <div class="box-footer">
                        <a href="?perfil=contrato&p=pf&sp=listagem">
                            <button class="btn btn-default pull-right">Ir para a listagem</button>
                        </a>
                    </div>
