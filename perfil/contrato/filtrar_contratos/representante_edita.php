        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <form method="POST" action="?perfil=contrato&p=filtrar_contratos&sp=representante_edita" role="form">
                        <div class="box-body">
                            <div class="row">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="?perfil=contrato&p=filtrar_contratos&sp=representante_edita" method="post">
