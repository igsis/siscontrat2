        ...
        if ($result = mysqli_query($con, $queryCNPJ)) {
            ...
            if ($resultCNPJ > 0) {
                ...
                $resultado = "<td colspan='4'>
                      ...
                      <td>
                        <form method='post' action='?perfil=contrato&p=filtrar_sem_operador&sp=cadastra_pj'>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="?perfil=contrato&p=filtrar_sem_operador&sp=pesquisa_pj" method="post">
