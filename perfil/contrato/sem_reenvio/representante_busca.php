...
if (isset($_POST['pesquisa'])) {
    ...
    if ($representante != null && count($representante) > 0) {
        ...
        $mensagem = "<form method='post' action='?perfil=contrato&p=sem_reenvio&sp=representante_edita'>
                        <tr>
        ...
        $mensagem = "<form action='?perfil=contrato&p=sem_reenvio&sp=representante_cadastra' method='post'>
                        <tr>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="?perfil=contrato&p=sem_reenvio&sp=representante_busca" method="post">
