    ...
    <div class="col-md-12">
        <div class="box box-default">
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-md-3">
                        <form method="POST" action="?perfil=contrato&p=sem_reenvio&sp=demais_anexos_pf"
                              role="form">
                    ...
                    <div class="form-group col-md-3 pull-right">
                        ...
                        <form method="POST" action="?perfil=contrato&p=sem_reenvio&sp=resumo" role="form">
...
<?php
modalUploadArquivoUnico("modal-rg", "?perfil=contrato&p=sem_reenvio&sp=edita_pf", "RG", "rg", $idPf, "1");
modalUploadArquivoUnico("modal-cpf", "?perfil=contrato&p=sem_reenvio&sp=edita_pf", "CPF", "cpf", $idPf, "1");
modalUploadArquivoUnico("modal-ccm", "?perfil=contrato&p=sem_reenvio&sp=edita_pf", "FDC - CCM", "ccm", $idPf, "1");
modalUploadArquivoUnico("modal-nit", "?perfil=contrato&p=sem_reenvio&sp=edita_pf", "NIT", "pis_pasep_", $idPf, "1");
modalUploadArquivoUnico("modal-facc", "?perfil=contrato&p=sem_reenvio&sp=edita_pf", "faq", "faq", $idPf, "1");
modalUploadArquivoUnico("modal-drt", "?perfil=contrato&p=sem_reenvio&sp=edita_pf", "DRT", "drt", $idPf, "1");
modalUploadArquivoUnico("modal-endereco", "?perfil=contrato&p=sem_reenvio&sp=edita_pf", "Comprovante de endereço", "residencia", $idPf, "1");
?>
