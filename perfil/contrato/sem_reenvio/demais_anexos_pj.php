                            ...
                            <div class="col-md-10 col-md-offset-1 text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        <br />
                                        <div class="center">
                                            <form method="POST" action="?perfil=contrato&p=sem_reenvio&sp=demais_anexos_pj" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="?perfil=contrato&p=sem_reenvio&sp=demais_anexos_pj" method="post">
