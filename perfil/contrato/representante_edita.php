...
<?php
modalUploadArquivoUnico("modal-$siglaRG", "?perfil=contrato&p=representante_edita", $nomeRg, $siglaRG, $idPj, $tipoRepresentante);
modalUploadArquivoUnico("modal-$siglaCPF", "?perfil=contrato&p=representante_edita", $nomeCpf, $siglaCPF, $idPj, $tipoRepresentante);
?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="?perfil=contrato&p=representante_edita" method="post">
