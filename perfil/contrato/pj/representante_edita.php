...
<?php
modalUploadArquivoUnico("modal-$siglaRG", "?perfil=contrato&p=pj&sp=representante_edita", $nomeRg, $siglaRG, $idRepresentante, $tipoRepresentante, $idPj);
modalUploadArquivoUnico("modal-$siglaCPF", "?perfil=contrato&p=pj&sp=representante_edita", $nomeCpf, $siglaCPF, $idRepresentante, $tipoRepresentante);
?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="?perfil=contrato&p=pj&sp=representante_edita" method="post">
