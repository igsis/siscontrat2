        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <form method="POST" action="?perfil=contrato&p=filtrar_periodo&sp=representante_edita" role="form">
                        <div class="box-body">
                            <div class="row">
...
<?php
modalUploadArquivoUnico("modal-$siglaRG", "?perfil=contrato&p=filtrar_periodo&sp=representante_edita", $nomeRg, $siglaRG, $idPj, $tipoRepresentante);
modalUploadArquivoUnico("modal-$siglaCPF", "?perfil=contrato&p=filtrar_periodo&sp=representante_edita", $nomeCpf, $siglaCPF, $idPj, $tipoRepresentante);
?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="?perfil=contrato&p=filtrar_periodo&sp=representante_edita" method="post">
