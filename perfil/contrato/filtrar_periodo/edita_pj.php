    ...
    <div class="col-md-12">
        <div class="box box-default">
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-md-3">
                        <form method="POST" action="?perfil=contrato&p=filtrar_periodo&sp=demais_anexos_pj"
                              role="form">
                    ...
                    if ($pj['representante_legal1_id'] == null && $pj['representante_legal2_id'] == null) {
                        ?>
                        <div class="form-group col-md-3">
                            <form method="POST" action="?perfil=contrato&p=filtrar_periodo&sp=representante_busca"
                                  role="form">
...
<?php
modalUploadArquivoUnico("modal-cnpj", "?perfil=contrato&p=filtrar_periodo&sp=edita_pj", "CNPJ", "cartao_cnp", $idPj, "2");
modalUploadArquivoUnico("modal-facc", "?perfil=contrato&p=filtrar_periodo&sp=edita_pj", "facc", "facc", $idPj, "2");
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="?perfil=contrato&p=filtrar_periodo&sp=edita_pj"
            ...
            <div class="modal-body text-center">
                ...
                <div class="col-md-12">
                    <div class="form-group col-md-6"><label><br></label>
                        <form method="POST" action="?perfil=contrato&p=filtrar_periodo&sp=representante_edita"
                              role="form">
