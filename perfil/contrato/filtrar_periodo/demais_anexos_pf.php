                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-md-10 col-md-offset-1 text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        <br/>
                                        <div class="center">
                                            <form method="POST" action="?perfil=contrato&p=filtrar_peridodo&sp=demais_anexos_pf"
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="?perfil=contrato&p=filtrar_peridodo&sp=demais_anexos_pf" method="post">
                        ...
                        <div class="box-footer">
                            <form action="?perfil=contrato&p=filtrar_peridodo&sp=edita_pf" method="post">
