                ...
                <div class="box box-info">
                    ...
                    <form role="form">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="tipo_atracao_id">Tipo de atração</label>
                                <select class="form-control" id="tipo_atracao_id" name="tipo_atracao_id">
                            ...
                            <div class="row ">
                                <div class="form-group col-md-6">
                                    <label for="fichaTecnica">Ficha técnica completa</label><br/>
                                    ...
                                    <textarea id="fichaTecnica" name="fichaTecnica" class="form-control" rows="8"></textarea>
                                </div>
                                <div class="form-group col-md-6">
