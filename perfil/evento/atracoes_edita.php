                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <label><input type="radio" name="oficina" value="1"
                                                  id="simOficina" <?= $atracao['oficina'] == 1 ? 'checked' : NULL ?>>
                                        Sim </label>&nbsp;&nbsp;
                                    <label><input type="radio" name="oficina"
                                                  value="0" <?= $atracao['oficina'] == 0 ? 'checked' : NULL ?>> Não
                                    </label>
                                </div>
                            </div>
