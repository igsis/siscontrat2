                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-2 text-center">
                                    ...
                                    <input class='form-control' type="text" id="genero" name="genero" size="30" value="<?= $teatro['genero'] ?>">
                                </div>
                                <div class="form-group col-md-2 text-center">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="descricao" id="descricao" maxlength="255" value="<?= $teatro['descricao'] ?>">
                                </div>
                            </div>
