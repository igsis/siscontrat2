                        ...
                        <form action="?perfil=evento&p=pf_edita" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" id="telefone" name="telefone[0]" onkeyup="mascara( this, mtel );" class="form-control" placeholder="Digite o telefone" required maxlength="15" data-mask="(99)99999.9999" pattern=".{14,15}"  title="14 a 15 caracteres">
                                </div>
                                <div class="form-group col-md-2">
                                    <label>Telefone #2:</label>
                                    <input type="text" id="telefone1" name="telefone[1]" onkeyup="mascara( this, mtel );" class="form-control" placeholder="Digite o telefone" maxlength="15" data-mask="(99)99999.9999" pattern=".{14,15}"  title="14 a 15 caracteres">
                                </div>
                                <div class="form-group col-md-2">
                                    <label>Telefone #3:</label>
                                    <input type="text" id="telefone2" name="telefone[2]" onkeyup="mascara( this, mtel );" class="form-control telefone" placeholder="Digite o telefone" maxlength="15" data-mask="(99)99999.9999" pattern=".{14,15}"  title="14 a 15 caracteres">
                                </div>
                            </div>
