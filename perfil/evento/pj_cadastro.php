                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" id="telefone" name="telefone[0]" onkeyup="mascara( this, mtel );" class="form-control" placeholder="Digite o telefone" required maxlength="15" pattern=".{14,15}"  title="14 a 15 characters">
                                </div>
                                <div class="form-group col-md-2">
