                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" id="telefone" name="telefone[0]" data-mask="(00) 00000-0000"
                                           onkeyup="mascara( this, mtel );" class="form-control"
                                           placeholder="Digite o telefone" required maxlength="15" pattern=".{14,15}"
                                           title="14 a 15 caracteres">
                                </div>
                                <div class="form-group col-md-2">
                                    <label>Telefone #2:</label>
                                    <input type="text" id="telefone1" name="telefone[1]" data-mask="(00) 00000-0000"
                                           onkeyup="mascara( this, mtel );" class="form-control"
                                           placeholder="Digite o telefone" maxlength="15" pattern=".{14,15}"
                                           title="14 a 15 caracteres">
                                </div>
                                <div class="form-group col-md-2">
                                    <label>Telefone #3:</label>
                                    <input type="text" id="telefone2" name="telefone[2]" data-mask="(00) 00000-0000"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" name="numero" id="numero" min="0" class="form-control"
