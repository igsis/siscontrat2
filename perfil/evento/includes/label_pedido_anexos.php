                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <br />
                            <div class="center">
                                <form class="formulario-ajax" method="POST" enctype="multipart/form-data" action="../funcoes/api_pedido_eventos.php" role="form" data-etapa="Anexos do Pedido">
                                    ...
                                    if($num_total != 0) {
                                        ?>
                                        <input type="hidden" name="_method" value="enviosArquivos">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form class="formulario-ajax" method="POST" action="../funcoes/api_pedido_eventos.php" role="form" data-etapa="Envio de Arquivos">
                                            <input type="hidden" name="_method" value="apagaArquivo">
