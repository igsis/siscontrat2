...
<form class="formulario-ajax" method="POST" action="../funcoes/api_pedido_eventos.php" role="form"
    ...
    <div class="form-group">
        ...
        <label for="topico2">Neste tópico deve-se falar sobre o evento ou atividade especial da qual o artista/grupo irá
    ...
    <div class="form-group">
        ...
        <label>Neste tópico deve-se falar sobre o currículo/biografia do artista ou grupo (na 3ª pessoa), escrever um
            breve release. Deve ficar claro que o artista contribuirá positivamente para a programação e porque essa é a
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="box box-default collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <label for="topico4">Neste tópico deve-se falar que o contratado tem o necessário para a contratação
                        e que as exigências legais foram observadas, apresentando a comprovação documental (mínimo três
                        comprovações diferentes) do valor proposto para o cachê. Encerrar com a manifestação favorável
        ...
        <div class="row">
            <div class="box box-default collapsed-box">
                ...
                <div class="box-body">
                    <label for="topico4">Neste tópico deve-se falar que o contratado tem o necessário para a contratação
                        e que as exigências legais foram observadas, apresentando a comprovação documental (mínimo três
                        notas fiscais de eventos que não foram contratados pela prefeitura) do valor proposto para o
    ...
    <div class="box-footer">
        ...
        <div class="pull-right">
            ...
            <button type="submit" class="btn btn-primary next-step">Próxima etapa <span aria-hidden="true">&rarr;</span>
            </button>
        </div>
