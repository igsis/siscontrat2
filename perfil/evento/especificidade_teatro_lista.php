                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="relacaoJuridica">Gênero</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="projetoEspecial">Venda</label>
                                    <class="form-control" id="Venda" name="venda">
                                        <input type="number" value="valor">informe o preço da venda, se houver.</input>
                                </div>
                            </div>
