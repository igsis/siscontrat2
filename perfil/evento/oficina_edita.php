                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="tel" name="valor_hora" placeholder="5,00" pattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$" value="<?= number_format($oficina['valor_hora'],2, ',', '.') ?>">
                                </div>
                            </div>
                            <div class="row">
                            <div class="form-group col-md-4">
                                <label for="inicio_inscricao">Início de inscrição: </label> <br/>
                                <input type="date" name="inicio_inscricao" value="<?= $oficina['inicio_inscricao'] ?>">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="encerramento_inscricao">Encerramento de inscrição: </label>
                                <input type="date" name="encerramento_inscricao" value="<?= $oficina['encerramento_inscricao']?>">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="data_divulgacao">Data de divulgação da inscrição: </label> <br/>
                                <input type="date" name="data_divulgacao" value="<?= $oficina['data_divulgacao'] ?>">
                            </div>
                            </div>
