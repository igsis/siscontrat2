                ...
                <div class="box box-info">
                    ...
                    <form method="POST" action="?perfil=evento&p=ocorrencia_edita" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="radio" name="virada" id="viradaNao" value="0" checked class="virada"> Não
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <a href="?perfil=evento&p=evento_cinema_lista"><button type="button" class="btn btn-default" id="voltar" name="voltar">Voltar</button></a>
