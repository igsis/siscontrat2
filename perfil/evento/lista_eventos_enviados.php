...
$sql = "SELECT * FROM eventos WHERE publicado = 1 AND agendao = 0 AND evento_status_id >= 3 AND contratacao = 0 AND (suplente_id = '$idUser' OR fiscal_id = '$idUser' OR usuario_id = '$idUser')";
