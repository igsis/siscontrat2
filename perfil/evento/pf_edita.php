                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="nome" placeholder="Digite o nome"
                                           maxlength="70" required value="<?= $pessoaFisica['nome'] ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="nomeArtistico"
                                           ...
                                           value="<?= $pessoaFisica['nome_artistico'] ?>">
                                </div>
                            </div>
                            <div class="row">
                                <?php
                                if (empty($pessoaFisica['cpf'])) {
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="passaporte" class="form-control"
                                               value="<?= $pessoaFisica['passaporte'] ?>" disabled>
                                    </div>
                                    <?php
                                } else {
                                    ?>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="dtNascimento" name="dtNascimento"
                                           onkeyup="barraData(this);" value="<?= $pessoaFisica['data_nascimento'] ?>"/>
                                </div>
                                <div class="form-group col-md-3">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" class="form-control" maxlength="60"
                                           placeholder="Digite o E-mail" required value="<?= $pessoaFisica['email'] ?>">
                                </div>
                                <div class="form-group col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="conta" class="form-control" placeholder="Digite a Conta"
                                           maxlength="12" required value="<?= $banco['conta'] ?>">
                                </div>
                            </div>
