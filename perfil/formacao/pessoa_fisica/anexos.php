...
if (isset($_POST["enviar"])) {
    $sql_arquivos = "SELECT * FROM lista_documentos WHERE tipo_documento_id = '$tipoDocumento' and publicado = 1";
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1 text-center">
                                <div class="table-responsive list_info"><h4><strong>Update de arquivos somente em
                                    ...
                                    WHERE arq.origem_id = '$idPf' AND list.tipo_documento_id = '$tipoDocumento'
                                        ...
                                        while ($arquivo = mysqli_fetch_array($query)) {
                                          ...
                                          <td class='list_description'>
                                                    <form id='formExcliuir' method='POST'>
                                                        <button class='btn btn-danger glyphicon glyphicon-trash' type='button' data-toggle='modal' data-target='#exclusao' data-nome='" . $arquivo['arquivo'] . "' data-id='" . $arquivo['id'] . "' data-pessoa='" . $tipoDocumento . "'>
                                                        </button></td>
                                                    </form>";
                                            echo "</tr>";
                                        }
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="center">
                                            <form method="POST"
                                                  action="?perfil=formacao&p=pessoa_fisica&sp=anexos"
                                                ...
                                                <table class="table text-center table-striped">
                                                    ...
                                                    <?php
                                                    $sql_arquivos = "SELECT * FROM lista_documentos WHERE id NOT IN (2, 3, 4, 25, 31, 51, 60, 62) AND tipo_documento_id = '$tipoDocumento' and publicado = 1";
                                                    $query_arquivos = mysqli_query($con, $sql_arquivos);
                                                    while ($arq = mysqli_fetch_array($query_arquivos)) {
                                                        $idDoc = $arq['id'];
                                                ...
                                                <input type="hidden" name="tipoPessoa" value="<?= $tipoDocumento; ?>"/>
