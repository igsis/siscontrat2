...
<div align="center">
    ...
    "<p>&nbsp;</p>".
    "<p>O presente processo trata da contratação de ". $objeto .", no valor de R$ ". dinheiroParaBr($pedido['valor_total']) . " (". valorPorExtenso($pedido['valor_total']) ." ), concernente a " . $trechoApre . ", no período " . retornaPeriodoNovo($idEvento, 'ocorrencias') . "</p>".
    "<p>Assim, solicito a reserva de recursos que deverá onerar a ação 6393 – Programação de Atividades Culturais do Centro Cultural São Paulo (Pessoa Jurídicas) da U.O. 25.10 - Fonte 00. </p>".
    "<p>&nbsp;</p>".
