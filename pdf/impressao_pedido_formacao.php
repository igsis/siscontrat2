...
<div align="center">
    ...
    $conteudo =
        ...
        "<p>&nbsp;</p>" .
        "<p><strong>Protocolo nº:</strong> " . $pedido['protocolo'] . "</p>" .
        ...
        "<p><strong>Data / Período:</strong> " . retornaPeriodoFormacao($fc['form_vigencia_id']) . " - conforme Proposta/Cronograma</p>" .
...
<div align="center">
    <button id="botao-copiar" data-clipboard-target="texto"> CLIQUE AQUI PARA COPIAR O
        TEXTO
    </button>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="http://sei.prefeitura.sp.gov.br" target="_blank">
        <button>CLIQUE AQUI PARA ACESSAR O </button>
    </a>
</div>
